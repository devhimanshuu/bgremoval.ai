      ...
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        <div className="flex flex-col sm:grid grid-cols-2 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="rounded-md border border-gray-600 h-full relative bg-layer overflow-hidden">
              {/* <img src={assets.image_wo_bg} alt="" /> */}
              <div className="absolute right-1/2 bottom-1/2 transform transform-x-1/2 translate-y-1/2">
                <div className="botder-4 border-violet-600 rounded-full h-12 w-12 border-t-transparent animate-spin"></div>
              </div>
            </div>
          </div>
        </div>
